module github.com/alexeykirinyuk/go_grpc_workshop/category-service
...
replace github.com/alexeykirinyuk/go_grpc_workshop/category-service/pkg/category-service => ./pkg/category-service
