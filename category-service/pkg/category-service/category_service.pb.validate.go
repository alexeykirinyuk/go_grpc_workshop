...
// Validate checks the field values on ExecTaskResponse with the rules defined
// in the proto definition for this message. If any rules are violated, an
// error is returned.
func (m *ExecTaskResponse) Validate() error {
	if m == nil {
		return nil
	}
...
// ExecTaskResponseValidationError is the validation error returned by
// ExecTaskResponse.Validate if the designated constraints aren't met.
type ExecTaskResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ExecTaskResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ExecTaskResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ExecTaskResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ExecTaskResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ExecTaskResponseValidationError) ErrorName() string { return "ExecTaskResponseValidationError" }

// Error satisfies the builtin error interface
func (e ExecTaskResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sExecTaskResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ExecTaskResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ExecTaskResponseValidationError{}
